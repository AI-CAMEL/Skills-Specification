...
##### <a name="ocsDoc"></a>OCS Document
A document that defines or describes a OCS resource.

##### <a name="resource"></a>Resources

A Resource is a first class domain object in OCS.
...
- A reference to a Resource ID, is a reference to a specific version of that resource for a specific tenant
- A reference to a Resource name must be resolved to a scope (tenant and version)
...
An OCS document compatible with OCS `1.*.*` contains a required [`openskill`](#ocsVersion) field which designates the semantic version of the OCS specification that it uses.
...
---|:---:|---
<a name="openskillVersion"></a>openskill | `string` | **REQUIRED**. This string MUST be the [semantic version number](https://semver.org/spec/v2.0.0.html) of the [OCS Specification version](#versions) that the OCS document uses. The `openskill` field SHOULD be used by tooling specifications and clients to interpret the OCS document. This is *not* related to the resource [`version`](#resourceVersion) string.
...
Field Name | Type | Description
---|:---:|---
[openskill](#ocsVersion) | `string` | **REQUIRED**. See [OCS Specification Version](#camelVersion).
...
Field Name | Type | Description
---|:---:|---
[openskill](#ocsVersion) | `string` | **REQUIRED**. See [OCS Specification Version](#ocsVersion).
[name](#resourceName) | `string` | **REQUIRED**. See [Resource Name](#resourceName).
[title](#resourceTitle) | `string` | **REQUIRED**. See [Resource Title](#resourceTitle).
[description](#resourceDescription) | `string` | **OPTIONAL**. See [Resource Description](#resourceDescription).
[tags](#resourceTags) | [[Tag Object](#tagObject)] | **OPTIONAL**. See [Resource Tags](#resourceTags).
